...
//		MqttListener callback = new ManagerMqttListen public void  doIt() {
	    try {
	    	JSONObject json = new JSONObject("{\"Temperature\":true,\"Luminosity\":false}");
	        File f1 = new File("/home/ramon/Estudos/2016_2/reuso_soft/spl/arduSPL/flags.h");
...
//	                line = line.replace("java", " ");
	        	...
	        	try {
	        		boolean status = json.getBoolean(line.substring(x));
