...
//		callback = new MqttListener();
		...
		try {
			...
			// Callback test
			 ...
			 System.out.println("Client Subscribed to : " + topicListener);
...
//			 publish("Hello i'm the manager!");
	...
	public void announce() throws MqttException {
		...
		msg.setPayload("{\"typeDevice\":\"screen\"}".getBytes());
        ...
        public boolean publish(String messageString) {
            ...
            return publish(messageString,topic);
        }
...
//	Builder pattern
	public static class DriverMqttBuilder {
		...
		private MqttListener listener;
                private MqttListener callback = null;
